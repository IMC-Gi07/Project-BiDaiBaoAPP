//
//  BDBRiskControlViewController.m
//  BiDaiBaoAPP
//
...
#import "BDBRiskControlViewController.h"
...
@interface BDBRiskControlViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation BDBRiskControlViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        ...
        introductionCell.introductionLeadingImageView.image = UIImageWithName(@"discovery_riskControl_img");
        introductionCell.introductionCellTitle.text = @"风险控制";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self performSegueWithIdentifier:@"DetailOfRiskControl" sender:self];
...
- (void)refreshDatas {
    ...
    parameters[@"TypeID"] = [NSString stringWithFormat:@"%d",27];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([@"DetailOfRiskControl" isEqualToString:segue.identifier]) {
