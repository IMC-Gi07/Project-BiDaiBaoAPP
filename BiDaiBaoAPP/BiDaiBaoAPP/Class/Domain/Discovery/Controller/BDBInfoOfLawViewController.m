...
#import "BDBInfoOfLawViewController.h"
...
@interface BDBInfoOfLawViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation BDBInfoOfLawViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        ...
        introductionCell.introductionLeadingImageView.image = UIImageWithName(@"discovery_infoOfLaw_img");
        introductionCell.introductionCellTitle.text = @"法律相关";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self performSegueWithIdentifier:@"DetailOfInfoOfLaw" sender:self];
...
- (void)refreshDatas {
    ...
    parameters[@"TypeID"] = [NSString stringWithFormat:@"%d",28];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([@"DetailOfInfoOfLaw" isEqualToString:segue.identifier]) {
