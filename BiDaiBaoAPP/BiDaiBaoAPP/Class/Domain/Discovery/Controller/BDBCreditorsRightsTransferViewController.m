//
//  BDBCreditorsRightsTransferViewController.m
//  BiDaiBaoAPP
//
...
#import "BDBCreditorsRightsTransferViewController.h"
...
@interface BDBCreditorsRightsTransferViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation BDBCreditorsRightsTransferViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        ...
        introductionCell.introductionLeadingImageView.image = UIImageWithName(@"discovery_creditorsRightsTransfer_img");
        introductionCell.introductionCellTitle.text = @"债权转让";
...
- (void)refreshDatas {
    ...
    parameters[@"TypeID"] = [NSString stringWithFormat:@"%d",29];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([@"CreditorsRightsTransfer" isEqualToString:segue.identifier]) {
