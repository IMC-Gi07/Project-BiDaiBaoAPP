//
//  BDBOperationModeViewController.m
//  BiDaiBaoAPP
//
...
#import "BDBOperationModeViewController.h"
...
@interface BDBOperationModeViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation BDBOperationModeViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        ...
        introductionCell.introductionLeadingImageView.image = UIImageWithName(@"discovery_operationMode_img");
        introductionCell.introductionCellTitle.text = @"运营模式";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self performSegueWithIdentifier:@"DetailOfOperationMode" sender:self];
...
- (void)refreshDatas {
    ...
    parameters[@"TypeID"] = [NSString stringWithFormat:@"%d",25];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([@"DetailOfOperationMode" isEqualToString:segue.identifier]) {
